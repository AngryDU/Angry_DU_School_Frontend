        ...
        <form>
          ...
          {isActive && (
            <div className={styles["accordion-content-h"]}>
              ...
              >
                <NavLink activeClassName={styles.active}  style={{ color: "white", textDecoration:"none" }} to="/StudOrderCard">
                  Show Order Card!
                </NavLink>
              </Button>
              ...
              {toggleCancelBtn && (
                ...
                >
                  <NavLink activeClassName={styles.active}   style={{ color: "white", textDecoration:"none" }} to="/">
                    Reject!
                  </NavLink>
                </Button>
              )}
   ...
   {!switchDialogueBtn && !toggleDialBtnApprovOrders && (
              ...
              onClick={() => {
                ...
                upliftTutObjToStudOrderCardHandler();
                    ...
                    <NavLink activeClassName={styles.active}  style={{ color: "white", textDecoration:"none" }} to="/PaymentFunc">
                     TO PAY!
                </NavLink>
              </Button>
            )}
